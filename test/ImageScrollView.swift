...
open class ImageScrollView: UIScrollView {
    ...
    fileprivate func recoverFromResizing() {
        ...
        var offset = CGPoint(x: boundsCenter.x - bounds.size.width/4.0, y: boundsCenter.y - bounds.size.height/4.0)
    ...
    @objc func doubleTapGestureRecognizer(_ gestureRecognizer: UIGestureRecognizer) {
        ...
        if zoomScale >= maximumZoomScale / 4.0 {
    ...
    fileprivate func zoomRectForScale(_ scale: CGFloat, center: CGPoint) -> CGRect {
        ...
        zoomRect.origin.x    = center.x - (zoomRect.size.width  / 4.0)
        zoomRect.origin.y    = center.y - (zoomRect.size.height / 4.0)
